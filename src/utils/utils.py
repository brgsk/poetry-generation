...
def prepare_tokenizer(tokenizer_hf_name: Union[Path, str], save_dir: Union[Path, str]):
    tokenizer = GPT2Tokenizer.from_pretrained(tokenizer_hf_name, use_fast=False)
